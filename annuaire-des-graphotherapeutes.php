...
<div class="w3-container w3-half">
 <div id="carte_france" class="w3-right" onmouseout="document.carte.src='images/ggre-fond-carte-france.png';"><img name="carte" src="/images/ggre-fond-carte-france.png" width="360" border="0" usemap="#Map" title ="Carte en cours de maintenance">
            <map name="Map">
                <!-- NORD -->
...
<div id="tab_recherche" class="w3-left"><div id="lightbox"><div id="lightbox-content"></div></div>
            <table width="360" height="300" border="0" cellspacing="0">
                <tr>
