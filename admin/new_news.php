...
<?php
	...
	if(isset($_POST["envoyer"]))
	{
		...
		$sql = "INSERT INTO news (titre,contenu,date_depot,document,actif) ";
		$sql .= "VALUES('".str_replace("'","''",$_POST["titre"])."','".str_replace("'","''",$_POST["contenu_article"])."',";
		$sql .= "'".date("Y-m-d")."','".$nom_file."','".$_POST["actif"]."');";
		...
		echo "<br /><br /><a href='news.php'>Retour aux articles</a></div>";
		exit();
	}
?>
