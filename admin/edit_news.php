...
<br>
        ...
        <?php if($fichier != "")
				{
				echo "<div id='doc'><small><a href='http://www.meife93.fr/files/".$fichier."' target='_blank'>Cliquez ici pour ouvrir le document joint � l'article</a></small><img src='http://meife93.fr/admin/images/drop.png' onclick='deleteDoc(\"".$id_news."\",\"news\",\"".$tab["document"]."\");' /></div><br>";
				}?>
<br><br>
