...
<?php
	$orderby = (isset($_GET["orderby"]))?$_GET["orderby"]:"id_news";
	$tri = (isset($_GET["tri"]))?$_GET["tri"]:"DESC";
	// Liste des véhicules 
	$sql = "SELECT * FROM news ORDER BY ".$orderby." ".$tri.";";
	...
	// Affichage du résultat
		if(mysqli_num_rows($res)>0)
		{
			...
			echo "<tr>";
			echo "<th>".getTri("news.php","titre")."Titre</a></th>";
			echo "<th>".getTri("news.php","date_depot")."Date</a></th>";
			echo "<th>".getTri("news.php","actif")."En ligne</a></th>";
			...
			while($tab = mysqli_fetch_array($res))
			{
				...
				echo "</td>";
				echo "<td><a href='edit_news.php?id_news=".$tab["id_news"]."'>";
