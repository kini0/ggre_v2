...
<div class="w3-row-padding">
    ...
    <option>Inscriptions</option>
      ...
      <input class="w3-input w3-border w3-round-medium" type="text" name="message" required="required" >
	  </div>
		<br>
...
<p class="Style21">Auvergne-Rhône Alpes – Suisse - Paca – Occitanie :</p>
 <strong>Anne-Marie Rebut</strong> - 06 85 64 62 81  - <a href="mailto:region1@ggre-asso.fr">region1@ggre-asso.fr</a><br>
	...
	<a href="mailto:region1@ggre-asso.fr">region1@ggre-asso.fr</a><br>
 <span class="Style4000">•</span>
	<p class="Style21">Ile de France – Hauts de France – Normandie – Grand Est – Centre-Val de Loire :</p>
 <strong>Laurence Bleines</strong> - 06 62 02 73 95 - <a href="mailto:region2@ggre-asso.fr">region2@ggre-asso.fr</a><br>
	<strong>Valérie Brachet</strong> - 06 80 24 72 90 - 
	<a href="mailto:region2@ggre-asso.fr">region2@ggre-asso.fr</a><br>
 <span class="Style4000">•</span>
...
<p class="Style21">Singapour</p><strong>Juliette de Poncins </strong><br>
 <a href="mailto:juliette.de.poncins@ggre-asso.fr">juliette.de.poncins@ggre-asso.fr</a>
</div>
