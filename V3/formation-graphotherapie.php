...
<title>Formation graphothérapie : formation graphologie - GGRE</title>
...
<meta name="keywords" content="Formation graphothérapie, Formation graphologie">
	
<meta name="description" content="Le GGRE vous propose une formation à la graphothérapie diplômante pour devenir graphothérapeute. Formation à la graphologie et rééducation de l’écriture.">
...
.bgimg-1 {
  ...
  background-image: url(images/GGRE-V3-fond32c.jpg);
  min-height: 80%;
}
...
<header class="bgimg-1 w3-display-container" style="padding:0px 5px; max-width: 1307px; margin: auto;" id="home">
  <div class="w3-display-middle w3-text-white w3-center" style="padding:0px">
    <div id="titre">Notre organisme<br>de formation<br>à la graphothérapie</div>
  </div> 
</header>


<!-- Section Informations Générales-->
<div class="w3-container w3-white w3-padding-large" style="max-width: 1307px; margin: auto;">	
<div class="w3-row">
  <p class="w3-left w3-large">Le GGRE département Formation, établissement d'Enseignement Supérieur Privé déclaré au rectorat de Paris, assure une <strong><a onclick="document.getElementById('formation').style.display='block'">formation professionnelle en graphothérapie</a></strong> et délivre un diplôme d’enseignement supérieur privé de Graphothérapeute-Rééducateur de l’Ecriture.
</p>
</div>
	
	<div id="formation" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom">
      <header class="w3-container w3-blue"> 
        <span onclick="document.getElementById('formation').style.display='none'" 
        class="w3-button w3-display-topright">&times;</span>
        <h2>Formation Professionnelle en Graphothérapie</h2>
      </header>
      <div class="w3-container"><br>
        <p>La formation dispensée par le GGRe, concrète et pratique, délivre un diplôme d’enseignement supérieur privé reconnu par le Rectorat de Paris et certifié par différentes instances publiques (Qualiopi, Datadock, etc).<br><br></p>
      </div>
    </div>
  </div>
...
<h2 class="w3-center w3-xxlarge Style300">Informations générales</h2>	
<div class="w3-row w3-light-grey w3-round-large">
	
	<div class="w3-container w3-half">
    <p class="w3-left w3-large">Notre organisme de formation à la graphothérapie est déclaré auprès de la Direction Régionale des Entreprises, de la Concurrence, de la Consommation, du Travail et de l’Emploi (DIRECCTE) sous le numéro de déclaration d’activité 11752780675. Cet enregistrement ne vaut pas agrément de l’Etat (article L.6352-12 du Code du travail).<br><br>
	Il est certifié <a href="https://travail-emploi.gouv.fr/formation-professionnelle/acteurs-cadre-et-qualite-de-la-formation-professionnelle/article/qualiopi-marque-de-certification-qualite-des-prestataires-de-formation" target="_blank"><strong>Qualiopi</strong></a> pour ses actions de formation et référencé sur diverses plateformes permettant une prise en charge (totale ou partielle) du coût de la formation au titre de la formation professionnelle continue :</p>
	</div>
	
	<div class="w3-container w3-half">
    <p class="w3-left w3-large">
<span class="Style200">•</span> <a href="https://www.data-dock.fr/" target="_blank"><strong>Datadock</strong></a><br>
<span class="Style200">•</span>	<a href="https://dokelio-idf.fr/" target="_blank"><strong>DOKELIO Ile-de-France</strong></a><br>
<span class="Style200">•</span>	<a href="https://www.formiris.org/" target="_blank"><strong>Formiris</strong></a><br>
<span class="Style200">•</span>	<a href="https://reseau.intercariforef.org/carif-oref/competences-carif-oref-auvergne-rhone-alpes" target="_blank"><strong>CARIF-OREF Auvergne-Rhône-Alpes</strong></a><br>
<span class="Style200">•</span> <a href="https://www.fifpl.fr/"><strong>FIF PL</strong></a><br>
<span class="Style25">(Fonds Interprofessionnel de Formation des Professionnels Libéraux).</span><br><br>
 Nous disposons de deux pôles de formation (Lyon et Paris) qui délivrent une formation identique.
Pour toute information complémentaire, <a href="contact-graphotherapeute.php" target="_blank"><strong>prenez contact avec notre association de graphothérapeutes.</strong></a>
</p>
	</div>
</div>
</div>
