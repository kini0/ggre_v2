...
<title>Actualités graphothérapie : conseil écriture - GGRE</title>
...
<meta name="keywords" content="Actualités graphothérapie">
	
<meta name="description" content="Suivez les actualités de la graphothérapie avec le GGRE. Conseils liés à l’écriture pour enfants, adolescents et adultes.">
...
.bgimg-1 {
  ...
  background-image: url("images/GGRE-V3-fond14c.jpg");
  min-height: 80%;
}
...
<header class="bgimg-1 w3-display-container" style="max-width: 1307px; margin: auto;" id="home">
  <div class="w3-display-middle w3-text-white w3-center" style="padding:40px">
    <div id="titre">Actualités<br>archivées<br>du GGRE</div>
  </div> 
</header>


<!-- Section Archives Actualités-->
<div class="w3-container w3-light-grey" style="padding:15px 16px; max-width: 1307px; margin: auto;" id="actus">
    <h3 class="w3-center w3-xxlarge Style300"><i class="fa fa-file-archive-o"></i> Actualités archivées du GGRE</h3>
  <p class="w3-center w3-large">Sommaire des actualités archivées du GGRE</p>

<!-- ligne Archives 1 -->	
<div class="w3-row w3-half w3-padding">
	 
<!-- Archive 1-->
<div class="w3-col w3-left w3-margin w3-border w3-round w3-padding w3-card-2" style="background-color: white">
	<span class="Style32">Article édité en Avril 2021</span>
	<h3 class="Style5000">L’importance de l'écriture manuscrite chez l’enfant une nouvelle fois démontrée dans une étude*.</h3><span class="Style25"><strong>« Les mouvements induits par l’écriture manuscrite, à la fois délicats et soigneusement contrôlés, contribuent à activer les zones du cerveau liées à l#apprentissage», ont écrit les auteurs. "Aucune preuve de tels schémas d'activation n'a été constatée lors de l'utilisation d'un clavier."</strong><br><br>
Alors que les temps d’écrans n’ont cessé d'augmenter depuis les 10 dernières années, que les programmes scolaires se digitalisent et que les compétences technologiques sont cruciales pour intégrer le marché de l’emploi, la neuroscientifique Audrye van der Meer rappelle qu’un environnement d'apprentissage optimal doit inclure les deux disciplines :
- L’écriture manuscrite pour le #developpementcognitif et le savoir-être (altruisme, esprit critique, travail en collectif, etc.) grâce à l'activation de différentes zones cérébrales lors du geste graphique
- L’écriture à l’ordinateur pour favoriser l’apprentissage technologique

* ”The Importance of Cursive Handwriting Over Typewriting for Learning in the Classroom”, Université des sciences et des technologies, Trondheim, Norvège</span><br><br>
<a href="https://www.weforum.org/agenda/2020/10/handwriting-children-digital-soft-skills/" target="_blank"><img src="images/GGRE-actus2-avril2021.jpg" width="100%"/></a><br><br>
</div>
	 
<!-- Archive 2-->
<div class="w3-col w3-left w3-margin w3-border w3-round w3-padding w3-card-2" style="background-color: white">
	<span class="Style32">Article édité en Décembre 2020</span>
	<h3 class="Style5000">Plusieurs études ont démontré l’importance d’apprendre l’écriture manuscrite et ses effets bénéfiques :</h3><br><span class="Style25"> Le cerveau apprend et retient mieux les informations lorsqu'on écrit à la main de façon cursive (étude de l'Université des sciences et technologies de Norvège).<br><br>

- L'écriture manuscrite active des zones de cerveau qui jouent un rôle important dans le fonctionnement de la mémoire et l’intégration de nouvelles informations<br><br>

- Ecrire à la main provoque des interconnexions cérébrales qui favorisent le développement d’activités linguistiques plus complexes (connaissance des règles orthographiques, rédaction de textes complets, etc.)

Plus d'informations dans cet article de Groupe PSYCHOLOGIES
#écriture #graphothérapie</span><br><br><a href="https://www.psychologies.com/Actualites/Education/Pourquoi-l-ecriture-cursive-a-la-main-est-elle-bonne-pour-le-cerveau" target="_blank"><img src="images/Pourquoi-l-ecriture-cursive-a-la-main-est-elle-bonne-pour-le-cerveau_imagePanoramique647_286.jpg" width="100%"/></a><br><br>
</div>
...
<!-- Archive 3-->
<div class="w3-col w3-left w3-margin w3-border w3-round w3-padding w3-card-2" style="background-color: white">
	<span class="Style32">Article édité en Février 2021</span>
	<h3 class="Style5000">La dyspraxie (trouble développemental de la coordination) touche en moyenne 1 enfant par classe.</h3><br><span class="Style25">Comme nous l'explique cette vidéo de l'Inserm,<br>ce trouble peut inclure certaines formes de dysgraphie<br>(trouble de l'écriture)<br>et se diagnostique à partir de 5 ans.</span><br><br><a href="http://swll.to/8d4SXBx" target="_blank"><img src="images/actus-GGRE-dyspraxie.jpg" width="100%" /></a><br><br>
</div>
	  
<!-- Archive 4-->
<div class="w3-col w3-left w3-margin w3-border w3-round w3-padding w3-card-2" style="background-color: white">
<span class="Style32">Article édité en Janvier 2021</span>
<h3 class="Style5000">Votre enfant ne fait pas exprès d'écrire "mal".</h3><span class="Style25"><strong>L'écriture est une compétence transversale. Ecrire est à la fois un geste, un langage et un acte, qui engage l'enfant tout entier. Dès son plus jeune âge, elle concourt à son développement et à sa socialisation.</strong><br><br>
 Le rôle du graphothérapeute est de l'aider à adopter une écriture qui lui permette :<br>
• De représenter sa pensée et de s'exprimer<br>
• De communiquer<br>
• De laisser une trace de lui-même<br>
• De participer à une culture collective, donc de s'intégrer à un groupe<br><br>
Nous sommes à votre écoute pour toute question concernant la mise en place d'une graphothérapie.</span><br><br><img src="images/160138544_1134875720259254_4905565312935066403_n.jpg
	" width="100%"/><br><br>
</div>
...
<!-- Accès actualités -->
<div class="w3-container w3-orange" style="padding:15px 16px; max-width: 1307px; margin: auto;" id="archives">
  <a href="archives-actualites-ggre.php" class="Style211"><p class="w3-center w3-large">Retour vers les actualités du GGRE <i class="fa fa-chevron-circle-right" style="font-size:18px"></i></p></a>
