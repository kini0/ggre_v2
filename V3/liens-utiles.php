...
<meta name="description" content="Découvrez les liens utiles recommandés par le GGRE. Informations sur la graphothérapie et la graphologie.">
...
<!-- Section Actualités-->
<div class="w3-container" style="padding:15px 5px 25px; max-width: 1307px; margin: auto;">
    <h3 class="w3-center w3-xxlarge Style300">Graphothérapie</h3>
  <ul class="w3-ul w3-center w3-large">
  <li><a href="https://afep-asso.fr/" target="_blank" title="Cliquez pour accèder au site">AFEP Association Française des Enfants Précoces</a></li>
  <li><a href="https://www.gbgt.be/" target="_blank" title="Cliquez pour accèder au site">GBGT Groupement Belge des Graphothérapeutes-Rééducateurs de l'écriture</a></li>
  <li><a href="https://centre-psyrene.fr/" target="_blank" title="Cliquez pour accèder au site">Psyrene</a></li>
  </ul>
	<br>
	<h3 class="w3-center w3-xxlarge Style300 w3-border-top w3-border-orange">Graphologie</h3>
  <ul class="w3-ul w3-center w3-large">
  <li><a href="https://www.graphologie.asso.fr/" target="_blank" title="Cliquez pour accèder au site">SFDG - Société Française De Graphologie</a></li>
  <li><a href="https://www.graphobel.be/" target="_blank" title="Cliquez pour accèder au site">ABG - Association Belge de Graphologie</a></li>
  <li>SRG - Société Romande de Graphologie</li>
  <li><a href="http://coursdegraphologie.com/" target="_blank" title="Cliquez pour accèder au site">Myriam Lepoutre</a></li>
  </ul>
