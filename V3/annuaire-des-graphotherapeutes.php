...
<!-- Section ANNUAIRE -->
<div id="annuaire" class="w3-container w3-row w3-center w3-padding w3-orange">
...
<div class="w3-container w3-half">
 <div id="carte_france" class="w3-right" onmouseout="document.carte.src='images/ggre-fond-carte-france.png';"><img name="carte" src="/images/ggre-fond-carte-france.png" width="387" height="377" border="0" usemap="#Map" title ="Carte en cours de maintenance">
            <map name="Map">
                <!-- NORD -->
...
<!-- Moteur de recherche -->
<div class="w3-container w3-half">
<div id="tab_recherche" class="w3-left"><div id="lightbox"><div id="lightbox-content"></div></div>
            <table width="390" height="300" border="0" cellspacing="0">
                <tr>
                ...
                <tr>
                <td valign="top" bgcolor="#ffffff" class="Style24 w3-padding-small"><span id="resultatRecherche" class="Style29"></span></td>
                </tr>
            </table>
