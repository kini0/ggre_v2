...
<div id="Layer global" style="position:relative; margin: 0 auto; width:650px; height:700px;">
    ...
    <?php 
        ...
        ?>
        <form method="POST" action="/admin_V2/auth/register.php">
            <?php 
                include 'auth/errors.php'; 
            ?>
            <i class="fa fa-user" style="font-size:14px; color:#343995"></i><label for="user_field" class="Style20" style="color:#343995"> Membre du bureau</label>
            <span class="Style290">
                <input type="text" id="user_field" name="username" required>
                <i class="fa fa-envelope" style="font-size:14px; color:#343995"></i><label for="user_field" class="Style20" style="color:#343995"> Email</label>
                <input type="email" id="user_field" name="email" required>
            ...
            <i class="fa fa-key" style="font-size:14px; color:#343995"></i><label for="C_mdp" class="Style20" style="color:#343995"> Confirmation Mot de passe</label>
            <input type="password" id="C_mdp" name="password_retype" required>
            
            <input type="submit" name="submit" value="Register"><br/>
        </form>
    </div>
        
    <!--<div class="Style25" id="Mdpoubli"><br />
        <a id="bt_forget_password" href="#">Mot de passe oublié ?</a>
        <a id="bt_forget_password" href="/admin_V2/GGRE-connect-ADMIN.php">Login here</a>
    </div>-->
