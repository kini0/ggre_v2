...
<div id="Layer global" style="position:relative; margin: 0 auto; width:650px; height:700px;">
    ...
    <div id="tableauform">
                    ...
                    switch($err)
                    {
                        ...
                        ?>
                            <div class="alert alert-success">
                                <strong>Success</strong> Rénittialisation du mot de passe reussite
                            </div>
                        <?php
        ...
        ?> 
        <form method="POST" action="/admin_V2/auth/login.php">
    ...
    <div class="Style25" id="Mdpoubli">
        <a id="bt_forget_password" href="/admin_V2/forgot-password.php">Mot de passe oublié ?</a>
