...
<div id="Layer global" style="position:relative; margin: 0 auto; width:650px; height:700px;">
    ...
    <div id="tableauform">
        ...
        <?php 
            if(isset($_GET['newp_err']))
            {
                    $err = htmlspecialchars($_GET['newp_err']);
                        ...
                        case 'failed':
                            ?>
                                <div class="alert alert-danger">
                                    <strong>Erreur</strong> Rénitialisation password echoué !
                                </div>
                            <?php
                            break;
        ...
        ?> 
        <form method="POST" action="/admin_V2/auth/resetpassword.php">
            <i class="fa fa-key" style="font-size:14px; color:#343995"></i><label for="user_field" class="Style20" style="color:#343995"> Create new password</label>
            <span class="Style290">
                <input type="password" id="user_field" name="password" required>

                <i class="fa fa-key" style="font-size:14px; color:#343995"></i><label for="mdp" class="Style20" style="color:#343995"> Confirm your password</label>
            </span>
            <input type="password" id="mdp" name="cpassword" required><br />
                <br />
    ...
    <div class="Style25" id="Mdpoubli">
        ...
        <a id="" href="/admin_V2/GGRE-register-ADMIN.php">Register here</a>
    </div>
