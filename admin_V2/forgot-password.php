...
<div id="Layer global" style="position:relative; margin: 0 auto; width:650px; height:700px;">
    ...
    <div id="tableauform">
                    ...
                    switch($err)
                    {
                        ...
                        ?>
                            <div class="alert alert-danger">
                                <strong>Erreur</strong> This email address does not exist!
                            </div>
                        <?php
                        break;
                    }
        ...
        <form method="POST" action="/admin_V2/auth/resetpassword.php">
            <i class="fa fa-user" style="font-size:14px; color:#343995"></i><label for="user_field" class="Style20" style="color:#343995"> Enter your email address</label>
            <span class="Style290"><br />
                <input type="email" id="user_field" name="email" required ><br /><br /><br />
            </span>
            <input type="submit" name="check-email" value="Forgot Password">
