...
<div id="Layer global" style="position:relative; margin: 0 auto; width:1050px; height:700px;">
  <div id="LogoGGRE"><a href="/index-formation.php"><img src="/images/GGRE-V2-logo1.jpg" width="323" height="291" title="Retour accueil zone orange"/></a></div>

<div id="MenuNav"><a href="/GGRE-organisme-form.php"><button class="buttonNav buttonNav1">Un organisme<br />de formation<br />référencé</button></a><a href="/GGRE-condition-admin.php"><button class="buttonNav buttonNav1">Les <br />conditions<br />d'inscription</button></a><a href="/GGRE-programme-form.php"><a href="/GGRE-organisation-cours.php"><button class="buttonNav buttonNav1">Organisation<br />des<br />cours</button></a><a href="/GGRE-programme-form.php"><button class="buttonNav buttonNav1">Programmes<br />de<br />formation</button></a><br /><button class="buttonNav2">ANNUAIRE</button><a href="/GGRE-contacts2.php"><button class="buttonNav buttonNav1">Nous contacter</button></a><br /><a href="/index.php"><button class="buttonHome buttonHome2"><i class="fa fa-home" style="font-size:30px"></i></button></a></div>
  ...
  <map name="Map">
    ...
    <table width="270" height="330" border="0" cellspacing="0">
	  ...
	  <td width="9" height="20" valign="bottom" bgcolor="#363b94">&nbsp;</td>
        ...
        <tr>
            <td width="9" height="20" valign="bottom" bgcolor="#363b94">&nbsp;</td>
            <td width="204" height="20" valign="bottom" bgcolor="#363b94" class="Style22">Recherche par d&eacute;partement :</td>
        </tr>
        <tr>
            <td height="25" valign="top" bgcolor="#363b94">&nbsp;</td>
            <td height="25" valign="top" bgcolor="#363b94"><select name="departement" id="departement" onchange="dept();" style="width: 185px;">
                    <option>          </option>
				    <?php
				    for ($i=1;$i<=95;$i++)
				    {
        ...
        <tr>
            <td height="25" valign="top" bgcolor="#363b94">&nbsp;</td>
            <td height="25" valign="top" bgcolor="#363b94"><select name="listeNoms" id="listeNoms" style="width: 185px;" onchange="rechercheNom();">
                    <option>          </option>
				    <?php
